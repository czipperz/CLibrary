 ...
 */
public class CLine extends Line2D implements Serializable, CDrawAble {
    private Point P1, P2;
    private int width;
    ...
    public CLine(Point P1 = new Point(), Point P2 = new Point()) {
        this.P1 = P1;
        this.P2 = P2;
    }
    ...
    public CDrawAble tick() { return this; }

    public Rectangle2D getBounds2D() { return new CRect(P1, P2); }

    public Point2D getP1() { return P1;   }
    public Point2D getP2() { return P2;   }

    public double getX1()  { return P1.x; }
    public double getY1()  { return P1.y; }
    public double getX2()  { return P2.x; }
    public double getY2()  { return P2.y; }
