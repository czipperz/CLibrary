...
final class CCollisionTester {
	...
	static boolean isCollision(CCollision object1, int object1X = 0, int object1Y = 0, CCollision object2, int object2X, int object2Y) {
		def distanceX = object1X - object2X
		def distanceY = object1Y - object2Y
		//If alligned:
	...
	static boolean isCollision(CCollision object1, Point2D object1Loc, CCollision object2, Point2D object2Loc) {
